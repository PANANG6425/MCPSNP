...
public class GamePanel extends JPanel{
	...
	public boolean moving = false,covercandling= false;
	public GamePanel() {
	...
	public void setCovercandle(boolean covercandling) {
		this.covercandling = covercandling;
	}
	...
	public void setAnimation() {
	    ...
	    else if (covercandling)
	        playerAction = Covercandle;
	    else
	        playerAction = IDLE;
	}
	...
	public void paintComponent(Graphics g) {
	    ...
	    try {
	        if (playerDir == 0) {
	            ...
	            g.drawImage(animations[4][aniIndex], (int) xDelta, (int) yDelta, 100, 100, null);
	            //Covercandle = false;
	        } else {
	            moving = false;
